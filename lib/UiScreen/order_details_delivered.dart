...
class OrderDetailsDelivered extends StatefulWidget {
  const OrderDetailsDelivered({super.key});

  @override
  State<OrderDetailsDelivered> createState() => _OrderDetailsDeliveredState();
}
                    ...
                    child:Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            Text("Rate this product",style: TextStyle(
                              fontFamily: fontSfProDisplayRegular,fontSize: 14.sp,color: dark_silver_5d6266
                            ),),
                            SizedBox(width: 14.w,),
                            RatingBar(
                                itemSize: 40,
                                ...
                                ratingWidget: RatingWidget(
                                    full: SvgPicture.asset(icon_star,width: 40.w,height: 40.h,color: green_34d16b,),
                                    // full: const Icon(Icons.star, color:yellow_FFC80h0),
                                    half: SvgPicture.asset(icon_star,width: 40.w,height: 40.h,color: green_34d16b,),
                                    // half: const Icon(Icons.star_half, color:yellow_FFC800,),
                                    empty:SvgPicture.asset(icon_star,width: 40.w,height: 40.h,color: line_e2e3e5,)),
